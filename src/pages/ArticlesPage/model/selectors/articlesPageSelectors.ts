...
export const selectArticlesPageIsInitialLoading = (state: StateSchema) =>
    state.articlesPage?.isInitialLoading || false;
...
export const selectArticlesPageView = (state: StateSchema) =>
    state.articlesPage?.view || ArticlesListView.LIST;
