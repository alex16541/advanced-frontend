...
import { HeadingNode, $createHeadingNode, $isHeadingNode, HeadingTagType } from '@lexical/rich-text';
import { ElementNode } from 'lexical';

const HEADING_REGEX = /^(#{1,5})\s/;

const createBlockNode =
    (createNode: (match: Array<string>) => ElementNode): ElementTransformer['replace'] =>
...
export const TEXT_EDITOR_TRANSFORMERS: Array<Transformer> = [
    HEADING,
    QUOTE,
    UNORDERED_LIST,
    ORDERED_LIST,
...
export const ALL_EDITOR_TRANSFORMERS: Array<Transformer> = [
    // TABLE,
    // HR,
    // IMAGE,
    // EMOJI,
