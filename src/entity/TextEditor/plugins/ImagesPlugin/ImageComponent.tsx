...
import { FloatingTextFormatToolbarPlugin } from '../FloattingTextFormatToolbarPlugin/FloatingTextFormatToolbarPlugin';
...
function BrokenImage(): JSX.Element {
    return (
        <div className="BrokenImageContainer">
            <Icon className="BrokenImage" Svg={ImageIcon} />
            <div className="BrokenImageText">Image not found</div>
        </div>
    );
}
        ...
        <Suspense fallback={null}>
            <>
                <div className="image-body">
                    ...
                    {showCaption && (
                        <div className="image-caption-container" ref={onRef}>
                            <LexicalNestedComposer
                                initialEditor={caption}
                                initialNodes={[RootNode, TextNode, LineBreakNode, ParagraphNode]}
                            >
                                <AutoFocusPlugin />
                                {rootRef && <FloatingTextFormatToolbarPlugin anchorElem={rootRef} />}
