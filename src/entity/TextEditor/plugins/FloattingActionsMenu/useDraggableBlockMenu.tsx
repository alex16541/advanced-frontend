...
import { DragEvent as ReactDragEvent, useCallback, useEffect, useRef, useState } from 'react';
...
function setMenuPosition(targetElem: HTMLElement | null, menuElem: HTMLElement, anchorElem: HTMLElement) {
    if (!targetElem) {
    ...
    const floatingElemRect = menuElem.getBoundingClientRect();
    const anchorElementRect = anchorElem.getBoundingClientRect();
...
export function useDraggableBlockMenu(
    ...
    onBlockElementChange?: (element: HTMLElement | null) => void,
) {
    const scrollerElem = anchorElem.parentElement;

    const isDraggingBlockRef = useRef<boolean>(false);
    const [draggableBlockElem, changeDraggableBlockElem] = useState<HTMLElement | null>(null);

    const setDraggableBlockElem = useCallback(
        (element: HTMLElement | null) => {
            changeDraggableBlockElem(element);
            onBlockElementChange?.(element);
        },
